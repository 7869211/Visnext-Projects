...
(function() {
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('.container.style1 > .wrapper > .inner', { style: 'flip-left', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		...
		onvisible.add('.container.style3 > .wrapper > .inner', { style: 'flip-left', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style4, h2.style4, h3.style4, p.style4', { style: 'fade-left', speed: 1000, intensity: 4, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container.style2 > .wrapper > .inner', { style: 'flip-left', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
